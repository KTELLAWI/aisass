const LandingLayout = ({
  ...
  return (
    <>
  <div className="fixed bg-[url('/background.png')] w-full h-full bg-no-repeat bg-cover ">
{/* <div className=' '>
  <svg id="download" class="w-100 h-100 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
